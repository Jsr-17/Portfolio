        ...
        <div className="col-lg-5 col-12">
          <div className="d-flex align-items-center justify-content-center h-100">
            <div class="p-3 bg-light text-dark border border-secondary rounded-3 shadow-lg my-3">
              ...
              <h3 class="text-secondary">-Passion for Programming</h3>
              <p class="mb-3 fs-5">
              ...
              <p class=" fs-5 pb-2">
                I enjoy every opportunity to work and learn new perspectives in
                the world of programming. I am convinced that, with dedication
                and effort, we can achieve extraordinary things.
              </p>
            </div>
          </div>
        </div>
